...
def myargs():
    ...
    parser.add_argument('--alist',
                        required=False,
                        default='adenine',
                        help='location of list contains names of proteins binds with adenine')
    parser.add_argument('--olist',
                        required=False,
                        default='other',
                        help='location of list contains names of proteins binds with other')
...
def load_data(adenines, others, voxel_folder, a_times, o_times):
...
def train_deepdrug(adenine_list, other_list, voxel_folder, batch_size, lr, epoch, output):
